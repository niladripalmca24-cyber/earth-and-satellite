...
export const LiveEarthFeedModal: React.FC<LiveEarthFeedModalProps> = ({
  ...
  if (isMiniMode) {
    return (
      <div className="fixed bottom-24 right-6 z-40 w-80 sm:w-96 glass-panel border-cyan-500/50 shadow-[0_0_30px_rgba(0,240,255,0.25)] rounded-lg overflow-hidden animate-in fade-in slide-in-from-bottom-3 font-ui pointer-events-auto">
        {/* Mini Header */}
        ...
        {/* Mini Viewport */}
        <div className="relative w-full h-52 bg-black overflow-hidden flex items-center justify-center">
  ...
  // Standard Modal View
  return (
    <div className="fixed inset-0 z-50 bg-black/85 backdrop-blur-md flex items-center justify-center p-3 sm:p-6 animate-in fade-in duration-200 pointer-events-auto">
      <div className="glass-panel border-cyan-500/40 w-full max-w-5xl max-h-[92vh] flex flex-col rounded-xl overflow-hidden shadow-[0_0_50px_rgba(0,240,255,0.2)]">
        
        {/* Top Control Bar */}
        <div className="flex items-center justify-between px-4 sm:px-6 py-3.5 bg-slate-950/80 border-b border-cyan-500/30">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="font-hero font-bold text-sm sm:text-base text-white tracking-wider flex items-center gap-2">
                REAL-LIFE EARTH OBSERVATION FEEDS
        ...
        <div className="flex items-center gap-1.5 px-4 sm:px-6 py-2.5 bg-slate-900/60 border-b border-slate-800 overflow-x-auto font-ui text-xs">
          {FEED_CHANNELS.map(ch => {
            ...
            return (
              <button
                ...
                className={`px-3 py-1.5 rounded flex items-center gap-2 transition-all whitespace-nowrap cursor-pointer ${
                  active 
